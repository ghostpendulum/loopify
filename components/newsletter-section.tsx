          ...
          <div className="max-w-2xl mx-auto">
            <BlurPanel className="p-8 lg:p-12 bg-white/40 backdrop-blur-md grain-texture">
              ...
              <h2 className="text-3xl lg:text-4xl font-bold text-neutral-900 mb-4">
                <AnimatedText text="Get early access to " delay={0.2} />
                <span className="italic font-light">
                  <AnimatedText text="new features." delay={0.5} />
                </span>
              </h2>
              <p className="text-lg text-neutral-600">
                Be the first to try new motion styles, export formats, and AI enhancements before anyone else.
              </p>
              </div>
              ...
              {!isSubmitted ? (
                ...
                >
                  ...
                  <h3 className="text-xl font-semibold text-neutral-900 mb-2">Welcome to Amplift</h3>
                  <p className="text-neutral-600">
                    Thank you for subscribing. You&apos;ll be first to know about new features and motion styles.
                  </p>
                </motion.div>
              )}
