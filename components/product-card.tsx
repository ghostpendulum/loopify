        ...
        <div className="absolute top-4 left-4 z-20">
          <span
            className={cn(
              ...
              product.badge === "Linkedin" && "bg-blue-500/90 text-white",
              product.badge === "Instagram" && "bg-fuchsia-500/90 text-white",
              product.badge === "X" && "bg-neutral-900/90 text-white",
            )}
          >
            {product.badge}
          </span>
      ...
      <div className="relative overflow-hidden" style={{ aspectRatio: "25/36" }}>
        <div className="relative w-full h-full">
          ...
          >
            ...
            {product.overlay && (
              <div className="absolute inset-0" style={{ background: product.overlay }} />
            )}
          </motion.div>
        </div>
      </div>
